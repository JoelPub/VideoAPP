  ...
  methods: {
    ...
    handleMouseDownOnElement(e) {
      ...
      let move = moveEvent => {
        ...
        pos.top = (currY - startY) * (1 / this.canvasScale) + startTop
        pos.left = (currX - startX) * (1 / this.canvasScale) + startLeft
      ...
      let move = moveEvent => {
        ...
        switch (point.length) {
          ...
          case 2:
            ...
            pos.left = +left + (hasL ? (width - newWidth) : 0)
            pos.top = +top + (hasT ? (height - newHeight) : 0)
            pos.width = newWidth
