...
import com.shj.code.util.CommonUtil;
...
public class GlobalExceptionHandler {
    ...
    public StandardResult httpRequestMethodHandler() {
    ...
    public StandardResult commonJsonExceptionHandler(CommonJsonException commonJsonException) {
    ...
    public StandardResult unauthorizedExceptionHandler() {
    ...
    public StandardResult unauthenticatedException() {
