...
import com.shj.code.enumration.Constants;
...
public class CommonUtil {
     ...
     * @return
     */
    public static StandardResult errorJson(ErrorEnum errorEnum) {
        StandardResult standardResult = new StandardResult();
        standardResult.setStatus(Integer.valueOf(errorEnum.getErrorCode()));
        standardResult.setMessage(errorEnum.getErrorMsg());
