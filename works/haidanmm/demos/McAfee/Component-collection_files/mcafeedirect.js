...
"5B261F2C-F155-4178-8A9C-E63827F08465_mtp_535_34.99":"https://www.mcafee.com/consumer/ipz/cart?moguid=8F356727-B359-4C2F-B667-ADC4047FF8AF&ccpubn=en-us:mtp_521:direct@modal2:from601:1yp:37.99"
			...
			//HP Direct
			if (usi_app.url.indexOf("cart-overview") != -1 && (usi_app.aff_id === "1067" || usi_app.aff_id === "1081" || usi_app.aff_id === "1330" || usi_app.aff_id === "1357" || usi_app.aff_id === "1358" || usi_app.aff_id === "1359" || usi_app.aff_id === "1360" || usi_app.aff_id === "1126" || usi_app.aff_id === "1133" || usi_app.aff_id === "1439" || usi_app.aff_id === "1202" || usi_app.aff_id === "1210" || usi_app.aff_id === "1501") && (usi_app.new_term === "0" || usi_app.new_term === "1" || usi_app.new_term === "2")) {
				usi_app.link = usi_app.append_hp_tt_param() + "&dc=1&vc=";
				usi_commons.load_view("4MJInYW9YJ8sk0zLpZHQ9NI", "37935", usi_commons.device + "_" + usi_app.get_locale());
			}
		...
		usi_app.load = function() {
				...
				if (usi_app.get_locale() === "ja-jp") {
					...
					if (usi_app.get_locale() !== "ja-jp" && !usi_cookies.value_exists("usi_upsell_clicked")) {
						...
						if (usi_app.get_locale() === "en-us" && usi_app.aff_id === "0" && !usi_cookies.value_exists("usi_upsell_clicked") && !usi_app.is_retention_audience && usi_app.is_direct_store_channel) {
							...
							//HP Direct
							if ((usi_app.aff_id === "1067" || usi_app.aff_id === "1081" || usi_app.aff_id === "1330" || usi_app.aff_id === "1357" || usi_app.aff_id === "1358" || usi_app.aff_id === "1359" || usi_app.aff_id === "1360" || usi_app.aff_id === "1126" || usi_app.aff_id === "1133" || usi_app.aff_id === "1439" || usi_app.aff_id === "1202" || usi_app.aff_id === "1210" || usi_app.aff_id === "1501") && (usi_app.new_term === "0" || usi_app.new_term === "1" || usi_app.new_term === "2")) {
								usi_app.link = usi_app.append_hp_tt_param() + "&dc=1&vc=";
			...
			if (usi_app.get_locale() === "en-ca" && usi_app.is_retention_audience && usi_app.aff_id != "752" && !usi_cookies.value_exists("usi_suppress_ret_tt")) {
				...
				usi_app.discount = (Number(usi_app.price) * .10).toFixed(2);
				usi_app.new_price = (Number(usi_app.price) - Number(usi_app.discount)).toFixed(2);
				usi_commons.load_view("aLubvS1o6v8WW1LEgEeprxx", "37465", usi_commons.device);
			}
			...
			if (usi_app.sem_type.indexOf(":ret:") != -1) {
				if (usi_app.get_locale() === "en-us") {
					...
					if (usi_app.is_enabled) {
						usi_commons.load_precapture("259M9KbQLFwrOYZbhhICLW7", "37427");
					} else {
				...
				if (usi_app.get_locale() === "en-ca") {
					usi_app.email_link = usi_app.append_ret_pc_param();
					if (usi_app.is_enabled) {
						usi_commons.load_precapture("ypDXL4nPhv9zfseq5TiaVTY", "37387");
					} else {
				...
				if (usi_app.get_locale() === "fr-ca") {
					usi_app.email_link = usi_app.append_ret_pc_param();
					if (usi_app.is_enabled) {
						usi_commons.load_precapture("WEVerF5r4QrYIRCY6orKX2Q", "37429");
					} else {
				...
				if (usi_app.is_enabled) {
					if (usi_app.get_locale() === "en-in") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("cedNgLRl7jqtHnshzv9rKQK", "38239");
					}
					if (usi_app.get_locale() === "en-tt") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("CpnU0oh7XAwDwRvPKv8OImp", "38237");
					}
					if (usi_app.get_locale() === "en-zw") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("liUwFExo3iWHXAFDbHFvdhV", "38235");
					}
					if (usi_app.get_locale() === "en-ph") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("uCeGngvo46SyobGiRks1IZk", "38233");
					}
					if (usi_app.get_locale() === "en-my") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("BwLG5clF7zItk0JVnXOXvkY", "38231");
					}
					if (usi_app.get_locale() === "en-sg") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("uLCB8pxRUDdbeBLXyZYIpyN", "38229");
					}
					if (usi_app.get_locale() === "en-nz") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("hrsCXAHc2tryZ3HqSttGZSm", "38227");
					}
					if (usi_app.get_locale() === "en-au") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("SLqoKFW6PVjAzLM2wcREGnE", "38225");

					}
					if (usi_app.get_locale() === "de-ch") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("5Pj3xDJcT85pWn1parNd3aA", "38249");

					}
					if (usi_app.get_locale() === "es-mx") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("P6iohYt36PFxjakb8t9PAek", "38253");

					}
					if (usi_app.get_locale() === "es-cl") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("SLqoKFW6PVjAzLM2wcREGnE", "38225");

					}
					if (usi_app.get_locale() === "es-co") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("v5590EwpXNibg8ecprYADNG", "38263");

					}
					if (usi_app.get_locale() === "es-ar") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("SqkNZcG8UDxuQ74C0t3ktCJ", "38265");

					}
					if (usi_app.get_locale() === "es-pe") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("sm9seuxq6Q3Y2el8PFZyXoj", "38267");

					}
					if (usi_app.get_locale() === "es-pa") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("Z32kXGdcHoxy6XZnljLCxqB", "38269");

					}
					if (usi_app.get_locale() === "fr-ca") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("OirX6dSB6omh9SfngI5kvti", "38273");

					}
					if (usi_app.get_locale() === "ja-jp") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("7x0e0mGWjKS38JZ6w9TLep1", "38291");

					}
					if (usi_app.get_locale() === "ko-kr") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("b4xNL4xUZfxhGBouMTlemZG", "38331");

					}
					if (usi_app.get_locale() === "pt-br") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("E2IU2KP7tXMespYYApD6rrF", "38341");

					}
					if (usi_app.get_locale() === "ru-ru") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("jEcQuM4EkcOvQH6sNHJH0Jr", "38343");

					}
					if (usi_app.get_locale() === "tr-tr") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("89MOJrDHQ21TToTjI2jUw2R", "38347");

					}
					if (usi_app.get_locale() === "ch-cn") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("37kpWjNZukpwh0TBzLt4tGG", "38349");

					}
					if (usi_app.get_locale() === "ch-hk") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("2Jy8zIoJxgSKLGgnumtTRt2", "38351");

					}
					if (usi_app.get_locale() === "ch-tw") {
						usi_app.email_link = usi_app.append_ret_pc_param();
						usi_commons.load_precapture("eO9W4wVTiJP8SxYwd8cvfCX", "38353");
