<template>
  <div class="top">
    <ul class="ulBottom" style="text-align:center;">
      ...
      <li>你会不会说走就走？</li>
      <li>满足你！</li>
      <li>2019年XXJJ酷蓝嘉年华,正式开启！</li>
      <li>一句话：</li>
      <li>XXJJ车主福利！豪华游轮船票！送！</li>
      <li>重磅预告</li>
    ...
    <ul>
      <li>1. 活动期间成为XXJJ新车主，并完成神秘挑战任务，有机会免费获得8月底船期5天4晚豪华游轮日本游船票一张；</li>
      <li>2. 五月XXJJ车主参与活动更可享受船上额外VIP待遇：参与游轮明星盛典活动等。</li>特别说明
      <li>1. 本次活动针对即日起至6月30日XXJJ新车主有效（以开票时间为准）。</li>
      <li>2. 参与活动的XXJJ新车主需要通过XX天猫旗舰店支付199元报名获取活动参与资格（后期可退），报名需备注车主姓名、手机号、车架号信息用于资格审核。</li>
      <li>3. 神秘挑战任务将于5月25日通过“XXJJ”官方微信、XX官网、XX商城及XX汽车天猫旗舰店相关活动页面公布。</li>
      <li>4. 挑战任务需通过“XXJJ”官方微信平台上传任务完成截屏，优先完成挑战任务者可获高级舱位的资格（房型从高到低有露台房、海景房、内舱房），舱位有限，先到先得。</li>
      <li>5. 若车主报名携带家属同往（最多2位同行家属），可以优惠价格购买舱位/房间，下单费用详见游轮订票系统，详情关注“XXJJ”官方微信平台。</li>
      ...
      <li>*在法律允许的范围内，最终活动解释权归XX公司所有</li>
    </ul>
  </div>
</template>
<script>
