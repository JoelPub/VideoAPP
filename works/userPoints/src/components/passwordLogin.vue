<template>
  <div class="loginBox">
    ...
    <ul class="loginBoxUl">
      ...
      <li>
        <input placeholder="请输入密码" :type="pwType" v-model="password">
    ...
    <button class="submitButton" @click="submit">登录</button>
    <div class="routePasswordLogin" @click="goLogin">短信验证码登录>></div>
...
<script  src="../../static/js/passwordLogin.js">
</script>
